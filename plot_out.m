syms q1 q2 q3 h
syms q1dot q2dot q3dot hdot

q = [q1; q2; q3; h];
qdot = [q1dot; q2dot; q3dot; hdot];

Yo = [130 270 80 330 0 0 0 0]
...
tester = subs([O;E1;E2;E3],q,Yo(1:length(q)).');
...
for j=1:int32(length(t)-1)
    tester = subs([O;E1;E2;E3],q,Yt(j,1:length(q)).');
    xdata(:,j) = tester(:,1);
    ydata(:,j) = tester(:,2);
end
